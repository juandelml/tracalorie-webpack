...
class App {
    ...
    _newItem(type, e) {
        ...
        if(name.value === '' || calories.value === '') {
            alert('Please fill in all fields / Por favor llena todos los campos');
            return;
        }
    ...
    _removeItem(type, e) {
        if(e.target.classList.contains('delete') || e.target.classList.contains('fa-xmark')) {
            if(confirm('Are you sure? / ¿Estás seguro?')) {
    ...
    _setLimit(e) {
        ...
        if(limit.value === '') {
            alert('Please add a limit / Por favor ingresa un límite');
            return;
        }
